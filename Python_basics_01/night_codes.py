...
#     - with two system attriubute soul and spirit both with value True
#     - instance attributes gender, age, nationality
...
# 9. write a function called checker
    ...
    #  control logic ( using if, elif and else).
        ...
        #  if number is greater than or eqal to 3 and less than4, print "Intermediate"
